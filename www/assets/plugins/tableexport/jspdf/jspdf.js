...
var jsPDF = function(){
	...
	return {
		...
		output: function(type, options) {
			...
			if(type == 'datauri') {
//				window.location.href = 'data:application/pdf;base64,' + Base64.encode(buffer);
                                var url = 'data:application/pdf;base64,' + Base64.encode(buffer);
                                var url_with_name = url.replace("data:application/pdf;", "data:application/pdf;name=factura.pdf;")
                                var html = '<html>' +
